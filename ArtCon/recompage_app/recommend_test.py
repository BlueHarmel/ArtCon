...
def get_recommend(pfcode):
    pre_pf = pd.read_csv('/Users/jnyum/Desktop/Git/artcon/ArtCon/recompage_app/pre_pf.csv')
    print(1)
    ...
    tfidf_matrix = sparse.load_npz('/Users/jnyum/Desktop/Git/artcon/ArtCon/recompage_app/test.npz')
    print(3)
    # TF-IDF 행렬 확인
