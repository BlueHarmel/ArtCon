...
def mainpage_app(request):
    ...
    # )
    # recommend2 = serializers.serialize(
    #    "json", Exhibit.objects.filter(E_name__contains="파랑새를")
    # )
    # recommend3 = serializers.serialize(
    #    "json", Exhibit.objects.filter(E_name__contains="전통공예명품전")
    # )
    # recommend4 = serializers.serialize(
    #    "json", Exhibit.objects.filter(E_name__contains="달마가")
    # )
    # banner1 = serializers.serialize(
    #    "json", Exhibit.objects.filter(E_name__contains="바당수업")
    # )
    # banner2 = serializers.serialize(
    #    "json", Exhibit.objects.filter(E_name__contains="나전장의")
    # )
    # banner3 = serializers.serialize(
    #    "json", Exhibit.objects.filter(E_name__contains="오프그리드")
    # )
    context = {
